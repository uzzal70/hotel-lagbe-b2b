...
const VoidHistory = () => {
  ...
  const url = `${baseUrl}/core/agent/findAllPaginatedAndFilteredVoidByAgentId?agentId=${agentId}&pageNumber=${
  ...
  return (
    ...
    >
      <HeaderTitle headerTitle={`Void History`} />
      <Box
        sx={{
          m: 2,
          p: { md: 3, xs: 0 },
