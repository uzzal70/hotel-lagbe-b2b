...
const ReissueHistory = () => {
  ...
  const columns = [
    ...
    {
      Header: 'Reissued Amount',
      accessor: 'reissue.totalAmount',
      Cell: (row) => {
        return (
          <Box>
            {commaNumber(row.value || 0)} {companyInfo.currencyType}
  ...
  const url = `${baseUrl}/core/agent/findAllPaginatedAndFilteredReissueByAgentId?agentId=${agentId}&pageNumber=${
