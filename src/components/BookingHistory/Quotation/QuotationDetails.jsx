...
import RefundableQuotaiton from './RefundableQuotaiton';
import ReissueQuotaiton from './ReissueQuotaiton';
...
const QuotationDetails = () => {
  ...
  const handleReissue = () => {
    navigate('/dashboard/request/reissue', {
      state: {
        title: 'Re-Issue Request',
      },
    });
  };
  ...
  return (
    ...
    >
      <HeaderTitle headerTitle={`Booking Details`} />
      <Box
        sx={{
          p: { xs: 2, md: 2 },
          borderRadius: '6px',
              ...
              >
                ...
                >
                  <Stack direction="row" spacing={{ xs: 1, md: 2 }}>
                    ...
                    <CustomTypography
                      value={
                        location?.state?.status || 'Refund Quotation Generate'
                      }
                      bgcolor="var(--yellow)"
                      fontcolor="var(--white)"
                      py={0.5}
                ...
                {location?.state?.status === 'Requested for Quatation' && (
                  ...
                  >
                    We&apos;re working on generating your refund quotation.
                    Thanks for your patience—we&apos;ll get back to you shortly!
                  </Box>
                )}
                <Grid container spacing={{ xs: 1, md: 2 }}>
                  <Grid item>
                    <Card
                      ...
                      value={'01 Aug 2023 16:40'}
                    />
                  </Grid>
                  <Grid item>
                    <Card
                      title={'Time Limit'}
                      value={'Before 01 Aug,2023 18:34'}
                    />
                  </Grid>
                  <Grid item>
